...
st.markdown("""
    ...
    /* GLOBAL TYPOGRAPHY: Reduced line-height for a professional feel */
    html, body, [class*="css"] { 
    ...
    .article-body {
        line-height: 1.6; /* Tightened from previous versions */
        font-size: 1.05rem;
    }
    ...
    /* RESPONSIVE IMAGES: Right-float on PC, Stacked on Mobile */
    .article-body img {
        float: right;
        margin-left: 20px;
        margin-bottom: 10px;
